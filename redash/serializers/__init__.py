...
def public_dashboard(dashboard):
    dashboard_dict = project(
        ...
        ("name", "layout", "dashboard_filters_enabled", "dashboard_filters_hidden", "allow_text_parameters", "updated_at", "created_at", "options"),
    )
...
def serialize_dashboard(obj, with_widgets=False, user=None, with_favorite_state=True):
    ...
    d = {
        ...
        "dashboard_filters_hidden": obj.dashboard_filters_hidden,
        "allow_text_parameters": obj.allow_text_parameters,
        "widgets": widgets,
        "options": obj.options,
